...
public class SearchAttractionsOperation extends Operation {
	...
	public static class SearchAttractionsOperationBuilder {
		...
		public SearchAttractionsOperation.SearchAttractionsOperationBuilder keyword(
				String keyword) {
		...
		public SearchAttractionsOperation.SearchAttractionsOperationBuilder pageSize(
				Integer pageSize) {
		...
		public SearchAttractionsOperation.SearchAttractionsOperationBuilder sort(
				String sort) {
			this.sort = sort;
			return this;
		}

		public SearchAttractionsOperation.SearchAttractionsOperationBuilder locale(
				String locale) {
			this.locale = locale;
			return this;
		}
